...
var reject = gdprConsent === null || gdprConsent === void 0 ? void 0 : gdprConsent.querySelector(".c_reject");
var accept = gdprConsent === null || gdprConsent === void 0 ? void 0 : gdprConsent.querySelector(".c_accept");
var partnersArr;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    partnersArr = _a.sent();
                    partnersArr.map(function (partner) {
                        return partners === null || partners === void 0 ? void 0 : partners.append(partner.createDOMNode());
                    });
                    console.log('Hello');
                    return [2 /*return*/];
            }
...
accept === null || accept === void 0 ? void 0 : accept.addEventListener("click", function () {
    disableConsentPopup();
    var cookiePartner = "true; vendors=[" + partnersArr.map(function (partner) { return partner.accepted ? partner.id : null; }).filter(function (val) { return val != null; }).join("|") + "]";
